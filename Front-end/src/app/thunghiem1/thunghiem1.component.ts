...
@Component({
  selector: 'app-thunghiem1',
  templateUrl: './thunghiem1.component.html',
  styleUrls: ['./thunghiem1.component.css']
})
export class Thunghiem1Component implements OnInit {
  ...
  columns = [
    ...
    {
      name: 'imageURL', text: 'ImageURL', class: 'd-sm-table-cell text-center',
    },
  ];
